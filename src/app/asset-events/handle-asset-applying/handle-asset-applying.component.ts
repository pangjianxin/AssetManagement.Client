...
export class HandleAssetApplyingComponent implements OnInit {
  ...
  apiUrl = `/api/assets/secondaryadmin/pagination/bythirdlevel?categoryId=${this.data.assetApplyingEvent.assetCategoryId}`;
  // 总数
  ...
  handleAssetApplying() {
    const model: HandleAssetApplyingViewmodel = {
