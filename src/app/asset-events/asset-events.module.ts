...
import { AssetApplyingCurrentUserComponent } from './asset-events-current-user/asset-applying-current-user/asset-applying-current-user.component';
import { AssetApplyingSeondaryAdminComponent } from './asset-events-secondary/asset-applying-seondary-admin/asset-applying-seondary-admin.component';
import { AssetReturningCurrentUserComponent } from './asset-events-current-user/asset-returning-current-user/asset-returning-current-user.component';
import { AssetReturningSecondaryAdminComponent } from './asset-events-secondary/asset-returning-secondary-admin/asset-returning-secondary-admin.component';
...
import { HandleAssetApplyingComponent } from './asset-events-secondary/asset-applying-seondary-admin/handle-asset-applying/handle-asset-applying.component';
import { AssetExchangingCurrentUserComponent } from './asset-events-current-user/asset-exchanging-current-user/asset-exchanging-current-user.component';
import { AssetExchangeSecondaryAdminComponent } from './asset-events-secondary/asset-exchange-secondary-admin/asset-exchange-secondary-admin.component';
