...
@Component({
  selector: 'app-asset-table-with-condition',
  templateUrl: './asset-table-with-condition.component.html',
  styleUrls: ['./asset-table-with-condition.component.scss']
})
export class AssetTableWithConditionComponent implements OnInit, OnChanges {
